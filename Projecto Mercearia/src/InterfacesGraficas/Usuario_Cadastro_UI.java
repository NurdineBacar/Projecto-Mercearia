	...
	public Usuario_Cadastro_UI() {
		...
		btnRegistar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					Usuario.registo(txtPrimeiroNome.getText().toUpperCase(),txtApelido.getText().toUpperCase(), genero, tipoDeUsuario, txtSenha1.getText(), txtNumeroDeTelefone.getText());
				} catch (Exception e1) {
		...
		JCheckBox chcSenha1 = new JCheckBox("");
		chcSenha1.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if(chcSenha1.isSelected()) {
					if(chcSenha1.isSelected()==true) {
						txtSenha1.setEchoChar((char)0);
					}else if(chcSenha1.isSelected()==false){
						txtSenha2.setEchoChar('*');
					}
				}
			}
		});
		chcSenha1.setBackground(new Color(255, 255, 255));
		chcSenha1.setBounds(362, 282, 20, 23);
		panel_1_1.add(chcSenha1);
		
		txtSenha1 = new JPasswordField();
		txtSenha1.addKeyListener(new KeyAdapter() {
			@Override
			public void keyReleased(KeyEvent e) {
				if(txtPrimeiroNome.getText().length()>0 && txtApelido.getText().length()>0 && txtSenha1.getText().length()>0 && txtSenha1.getText().length()<4) {
		...
		txtSenha1.setBounds(78, 284, 278, 20);
		...
		txtSenha2.setBounds(146, 102, 248, 20);
		editarU.add(txtSenha2);
		
		JCheckBox chcSenha2 = new JCheckBox("");
		chcSenha2.setBackground(Color.WHITE);
		chcSenha2.setBounds(407, 100, 20, 23);
		editarU.add(chcSenha2);
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					Usuario.editarUsuario(codigo, txtNomeUpdate.getText().toUpperCase(),txtApelidoUpdate.getText().toUpperCase(), generoUpdate, tipoDeUsuarioUpdate, txtSenha2.getText(), txtNumeroUpdate.getText());
					tabela.setModel(new DefaultTableModel(
							Bd.tabelaUsuarios(),
							new String[] {
								"#CODIGO", "NOME", "APELIDO", "GENERO", "TIPO DE USUARIO", "USERNAME", "SENHA", "N\u00BA DE TELEFONE"
		...
		tabela.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				txtSenha2.setText(tabela.getValueAt(fila, 6)+"");
